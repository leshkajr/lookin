...
@section('title', 'Всі ваші помешкання')
@section('header')
...
@section('content')
    <main>
        <div class="d-flex justify-content-center align-items-center flex-column">
            ...
            <div class="container-listings-control">
                @foreach($hostListings as $listing)
                    <div class="listing-control d-flex flex-row align-items-center">
                        ...
                        <div class="listing-control-category">
                            {{ Lang::get('categories.'.$listing['category']->nameCategoryListing) }}
                        </div>
                        <div class="listing-control-location">
                            {{ $listing['city']['name'] }}, {{ $listing['country']['name'] }}
                        </div>
                        <div class="listing-control-reviews">
                            {{ $listing['countReviews'] }} reviews
                        </div>
                        <div class="listing-control-action">

                            @if($listing['isPublic'] === 1)
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">

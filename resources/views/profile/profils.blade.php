...
@section('content')
    <main class="d-flex flex-row" style="margin-top: 5%;margin-left: 10%">
        ...
        <div class="d-flex flex-column" style="margin-left: 13%;padding-top: 2%;width: 70%">
            ...
            <div style="margin-top: 3%;font-size: 14px; width: 65%">Інформацію, яку ви надаєте, буде використано на Look'in,
            ...
            <div class="personal_block">
                <form>
                    ...
                    <div class="personal_divs" style="padding-left: 2%;padding-top: 1%;padding-bottom: 1%;">
                        <input type="text" placeholder="Де ви навчалися?" class="input_text" style="font-size: 20px; font-weight: 200">
                    </div>

    ...
    <div class="d-flex flex-row">
     <div class="div_information">
        ...
        <div class="div_information" style="margin-top: 4%">
            <div style="font-size: 14px;margin-left: 10%;font-weight: 600">Підтверджена інформація про користувача</div>
        ...
        <div class="div_information" style="margin-top: 4%">
            ...
            <div style="width: 65%;margin-left: 10%;font-size: 10px;margin-top: 3%">Перш ніж бронювати або приймати гостей на Look'in, необхідно виконати цей крок.</div>
            <div class="informati" style="margin-top: 3%">

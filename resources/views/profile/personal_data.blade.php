...
@section('content')
    <main>
       <div class="d-flex flex-column" style="margin-left: 8%;margin-top: 7%">
          <div class="text-header" style="margin-left: 2%">Особисті дані</div>
           <div class="d-flex flex-row gap-1" style="margin-left: 2%" >
               ...
               <div style="text-decoration: underline"><a href="#" >Перейти до профылю</a></div>
                  ...
                  <div class="personal_block">
                      ...
                      <div class="personal_divs">
                         <div class="div_button" >
                             <div class="personal_text_description" style="margin-top: 1%;margin-bottom: 1%">Додати фото</div>
                             <label for="photo" style="margin-right: 2%;margin-top: 1%;">
                                 <svg width="30" height="30" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
           ...
           <div class="personal_block">
               <form>
                   <div class="personal_text_header">Адреса</div>
           ...
           <div class="personal_block">
               <form>
                   <div class="personal_text_header">Контактна особа для екстреного зв’язку</div>
